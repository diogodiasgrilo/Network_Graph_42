import { r as registerInstance, h, e as Host, g as getElement } from './index-356a3695.js';

var NetworkNodeType;
(function (NetworkNodeType) {
    NetworkNodeType["Worker"] = "extra";
    NetworkNodeType["Employer"] = "establishment";
...
const networkGraphCss = ":host{display:block}";

const NetworkGraph = class {
    constructor(hostRef) {
        registerInstance(this, hostRef);
        this.nodes = [];
        this.links = [];
        this.radiusLowerLimit = 10;
        this.radiusUpperLimit = 30;
        this.lineWidthLowerLimit = 1;
        this.lineWidthUpperLimit = 10;
    }
    componentDidLoad() {
    ...
    drawNode(node) {
        ...
        image.onload = () => {
            // Set the radius of the circle based on node appearances.
            let radius = this.radiusLowerLimit;
            ...
            // Draw the image at the center of the node's position.
            this.context.drawImage(image, node.x - radius, node.y - radius, radius * 2, radius * 2);
        };
    ...
    render() {
        return (h(Host, null, h("canvas", { width: "1800", height: "1800" })));
    }
    get element() { return getElement(this); }
};
NetworkGraph.style = networkGraphCss;

export { NetworkGraph as network_graph };
